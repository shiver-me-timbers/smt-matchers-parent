 ...
 * @author Karl Bennett
 */
public class BeforeDateMatcher extends TimeOperationsDateMatcher {

    private final Date expected;
    private final Long duration;
    private final TimeUnit unit;

    public BeforeDateMatcher(TimeOperations timeOperations, Date expected, Long duration, TimeUnit unit) {
